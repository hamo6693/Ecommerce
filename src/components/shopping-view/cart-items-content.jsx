...
import { deleteMyCart, updateMyCart } from "../../srore/shop/cart-slice";





function CartItemsContent({cartItem ,setOpenCartSheet }) {
    const dispatch = useDispatch()
    const {user} = useSelector(state => state.auth)

    function handleDeleteCart(getCartItem){
        dispatch(deleteMyCart({userId:user?.id,productId:getCartItem?.productId}))
    }
